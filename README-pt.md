...
> **Estado: 0.1.5, em desenvolvimento.** O núcleo em Python está implementado e coberto por CI. O lançador está coberto por dez verificações sobre a descoberta de interpretadores, que é onde já se enganou antes. As interfaces podem mudar antes de 1.0.
